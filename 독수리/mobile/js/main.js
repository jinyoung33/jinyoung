$(function(){
    ...
    if($('.product_thumb_slides').length){
        ...
        var swiper = new Swiper('.product_thumb_container', {
          ...
          //이미지 변경하기
          var thumImg = $('.product_thumb_slides li img');
          var tartgetImg = $('.product_img_top img');

          thumImg.click(function(){
            var tartgetImgUrl = $(this).attr('src');
            tartgetImg.attr('src',tartgetImgUrl);
          });
...
function newFunction(totalprice) {
